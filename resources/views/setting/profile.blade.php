                ...
                <div class="card-body">
                    ...
                    <form id="form">
                        ...
                        <div class="form-group">
                            <label> Nama Lengkap   {!! App\MyClass\Template::requiredBanner() !!} </label>
                            <input type="text" name="name" class="form-control" placeholder="Masukkan Nama Lengkap" value="{{ auth()->user()->name }}">
                            <span class="invalid-feedback"></span>
                        </div>
    
                        <div class="form-group">
                            <label> Email   {!! App\MyClass\Template::requiredBanner() !!} </label>
                        ...
                        <div class="form-group">
                            <label> Nomor Telepon   {!! App\MyClass\Template::requiredBanner() !!} </label>
                            <p class="small text-muted">
                        ...
                        <div class="form-group">
                            <button class="btn" style="background-color: #002E5B; color: white" type="submit">
            ...
            $form.find(`[name="upload_avatar"]`).on('change', function(){
                ...
                if(!empty(file)){
                    ...
                    if(fileType.substring(0, 5) !== 'image'){
                        toastAlert()
                        toastr.warning('file harus berupa gambar', 'Peringatan')
                        $(this).val('');
                    } else{
